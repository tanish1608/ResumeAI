...
export const defaultResumeData: ResumeData = {
  ...
  professionalSummary:
    "Innovative Software Engineer pursuing MS in Computer Engineering at NYU with 2+ years of experience in full-stack development and AI/ML applications. Proven track record of delivering scalable solutions at Thunder Client and HSBC, including SSO integrations, API documentation tools, and real-time monitoring systems. Patent holder in AI-based systems with expertise in TypeScript, Python, React, and cloud technologies. Passionate about leveraging cutting-edge technologies to solve complex problems and drive business impact.",
  education: [
    {
      id: "edu1",
      ...
      gpa: "",
      relevantCoursework:
        "Data Structures & Algorithms, Machine Learning, Database Systems, Computer Networks, Software Architecture, NLP, Operating Systems, Image Processing",
    },
    {
      id: "edu2",
      ...
      gpa: "3.8/4.0",
      relevantCoursework:
        "Advanced Data Structures, Object-Oriented Design, Distributed Systems, IoT & Embedded Systems, Compiler Design",
    },
  ],
  experience: [
    {
